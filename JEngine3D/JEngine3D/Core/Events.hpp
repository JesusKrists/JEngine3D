...
namespace JE {
    ...
    public:
        ...
        inline auto Dispatch(T func) -> bool
        {
    ...
    {
    public:
        explicit IWindowEvent(IPlatform::NativeWindowHandle handle) : m_Handle(handle) {}

        [[nodiscard]] inline auto Category() const -> EventCategory override { return EventCategory::Window; }
        [[nodiscard]] inline auto NativeWindowHandle() const -> IPlatform::NativeWindowHandle { return m_Handle; }

    private:
        IPlatform::NativeWindowHandle m_Handle;
    };

    class WindowResizeEvent final : public IWindowEvent
    {
    public:
        WindowResizeEvent(IPlatform::NativeWindowHandle handle, const Size2DI& size) : IWindowEvent(handle), m_Size(size) {}
    ...
    {
    public:
        WindowMoveEvent(IPlatform::NativeWindowHandle handle, const Position2DI& position) : IWindowEvent(handle), m_Position(position) {}
    ...
    class WindowMinimizedEvent final : public IWindowEvent
    {
        using IWindowEvent::IWindowEvent;

    public:
        [[nodiscard]] inline auto Type() const -> EventType override { return EventType::WindowMinimized; }
    };

    class WindowMaximizedEvent final : public IWindowEvent
    {
        using IWindowEvent::IWindowEvent;
    ...
    {
    public:
        explicit IKeyboardEvent(IPlatform::NativeWindowHandle handle) : m_Handle(handle) {}

        [[nodiscard]] inline auto Category() const -> EventCategory override { return EventCategory::Keyboard; }
        [[nodiscard]] inline auto WindowHandle() const -> IPlatform::NativeWindowHandle { return m_Handle; }
    ...
    {
    public:
        KeyPressEvent(IPlatform::NativeWindowHandle handle, KeyCode key, const KeyModifiers& modifiers = KeyModifiers(), int32_t repeat = 0)
    ...
    {
    public:
        KeyReleaseEvent(IPlatform::NativeWindowHandle handle,
                        KeyCode                       key,
    ...
    {
    public:
        TextInputEvent(IPlatform::NativeWindowHandle handle, const std::string_view& text) : IKeyboardEvent(handle), m_Text(text) {}
    ...
    {
    public:
        explicit IMouseEvent(IPlatform::NativeWindowHandle handle, const Position2DI& position) : m_Handle(handle), m_Position(position) {}
    ...
    {
    public:
        MousePressEvent(IPlatform::NativeWindowHandle handle, const Position2DI& position, MouseButton button, int32_t clicks)
    ...
    {
    public:
        MouseReleaseEvent(IPlatform::NativeWindowHandle handle, const Position2DI& position, MouseButton button, int32_t clicks)
            : IMouseEvent(handle, position), m_Button(button), m_Clicks(clicks)
        {}
    ...
    {
    public:
        MouseMoveEvent(IPlatform::NativeWindowHandle handle,
    ...
    {
    public:
        explicit MouseWheelEvent(IPlatform::NativeWindowHandle handle, int32_t scrollAmount, const Position2DI& position = { 0, 0 })
