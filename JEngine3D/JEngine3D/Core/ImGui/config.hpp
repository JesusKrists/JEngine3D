...
#define IM_VEC2_CLASS_EXTRA                                                                                                                \
    ...
    inline operator JE::Size2DI() const { return JE::Size2DI{ static_cast<int32_t>(x), static_cast<int32_t>(y) }; }                        \
    ImVec2(const JE::Position2DI& pos) : x(static_cast<float>(pos.X)), y(static_cast<float>(pos.Y)) {}                                     \
    inline operator JE::Position2DI() const { return JE::Position2DI{ static_cast<int32_t>(x), static_cast<int32_t>(y) }; }                \
...
#define IM_VEC4_CLASS_EXTRA                                                                                                                \
    ...
    inline operator JE::Color() const { return JE::Color{ x, y, z, w }; }                                                                  \
