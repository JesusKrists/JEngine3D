...
inline auto JEngine3DKeyCodeToString(KeyCode keyCode) -> const char *
{
  ...
  case KeyCode::KeyPadComma:
    return "KeyPadComma";
  case KeyCode::KeyPadEqualsAs400:
    return "KeyPadEqualsAs400";
  ...
  case KeyCode::ExSel:
    return "ExSel";
  case KeyCode::KeyPad00:
    return "KeyPad00";
  case KeyCode::KeyPad000:
    return "KeyPad000";
  case KeyCode::ThousandSeparator:
  ...
  case KeyCode::KeyPadLeftParen:
    return "KeyPadLeftParen";
  case KeyCode::KeyPadRightParen:
    return "KeyPadRightParen";
  case KeyCode::KeyPadLeftBrace:
    return "KeyPadLeftBrace";
  case KeyCode::KeyPadRightBrace:
    return "KeyPadRightBrace";
  case KeyCode::KeyPadTab:
    return "KeyPadTab";
  case KeyCode::KeyPadBackSpace:
    return "KeyPadBackSpace";
  case KeyCode::KeyPadA:
    return "KeyPadA";
  case KeyCode::KeyPadB:
    return "KeyPadB";
  case KeyCode::KeyPadC:
    return "KeyPadC";
  case KeyCode::KeyPadD:
    return "KeyPadD";
  case KeyCode::KeyPadE:
    return "KeyPadE";
  case KeyCode::KeyPadF:
    return "KeyPadF";
  case KeyCode::KeyPadXOR:
    return "KeyPadXOR";
  case KeyCode::KeyPadPower:
    return "KeyPadPower";
  case KeyCode::KeyPadPercent:
    return "KeyPadPercent";
  case KeyCode::KeyPadLess:
    return "KeyPadLess";
  case KeyCode::KeyPadGreater:
    return "KeyPadGreater";
  case KeyCode::KeyPadAmpersand:
    return "KeyPadAmpersand";
  case KeyCode::KeyPadDblAmpersand:
    return "KeyPadDblAmpersand";
  case KeyCode::KeyPadVerticalBar:
    return "KeyPadVerticalBar";
  case KeyCode::KeyPadDblVerticalBar:
    return "KeyPadDblVerticalBar";
  case KeyCode::KeyPadColon:
    return "KeyPadColon";
  case KeyCode::KeyPadHash:
    return "KeyPadHash";
  case KeyCode::KeyPadSpace:
    return "KeyPadSpace";
  case KeyCode::KeyPadAt:
    return "KeyPadAt";
  case KeyCode::KeyPadExclam:
    return "KeyPadExclam";
  case KeyCode::KeyPadMemStore:
    return "KeyPadMemStore";
  case KeyCode::KeyPadMemRecal:
    return "KeyPadMemRecal";
  case KeyCode::KeyPadMemClear:
    return "KeyPadMemClear";
  case KeyCode::KeyPadMemAdd:
    return "KeyPadMemAdd";
  case KeyCode::KeyPadMemSubtract:
    return "KeyPadMemSubtract";
  case KeyCode::KeyPadMemMultiply:
    return "KeyPadMemMultiply";
  case KeyCode::KeyPadMemDivide:
    return "KeyPadMemDivide";
  case KeyCode::KeyPadPlusMinus:
    return "KeyPadPlusMinus";
  case KeyCode::KeyPadClear:
    return "KeyPadClear";
  case KeyCode::KeyPadClearEntry:
    return "KeyPadClearEntry";
  case KeyCode::KeyPadBinary:
    return "KeyPadBinary";
  case KeyCode::KeyPadOctal:
    return "KeyPadOctal";
  case KeyCode::KeyPadDecimal:
    return "KeyPadDecimal";
  case KeyCode::KeyPadHexDecimal:
    return "KeyPadHexDecimal";
  case KeyCode::LCtrl:
    return "LCtrl";
  case KeyCode::LShift:
    return "LShift";
