...
namespace JE {
    ...
    public:
        ...
        IPlatform()
        {
            ASSERT(!s_PlatformInstance, "Platform backend instance already created");
            s_PlatformInstance = this;
        }

        [[nodiscard]] static inline auto Get() -> IPlatform&
        {
            ASSERT(s_PlatformInstance, "Platform backend instance is null");
        ...
        virtual ~IPlatform() { s_PlatformInstance = nullptr; };
    ...
    private:
        ...
        JAPI static IPlatform* s_PlatformInstance;// NOLINT
    };
