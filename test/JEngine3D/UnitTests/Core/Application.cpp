...
TEST_CASE_METHOD(ApplicationTestsFixture, "JE::Application is run and stops running after receiving QuitEvent", "[JE::Application]")
{
...
TEST_CASE_METHOD(ApplicationTestsFixture, "JE::Application is run and dispatches WindowCloseEvent to WindowController", "[JE::Application]")
{
    auto& window = m_WindowController.CreateWindow(NEW_WINDOW_TITLE, NEW_WINDOW_SIZE);
...
TEST_CASE_METHOD(ApplicationTestsFixture, "JE::Application is run and dispatches KeyPressEvent to InputController", "[JE::Application]")
{
    auto& window = m_WindowController.CreateWindow(NEW_WINDOW_TITLE, NEW_WINDOW_SIZE);
...
TEST_CASE_METHOD(ApplicationTestsFixture, "JE::Application is run and dispatches KeyReleaseEvent to InputController", "[JE::Application]")
{
    auto& window = m_WindowController.CreateWindow(NEW_WINDOW_TITLE, NEW_WINDOW_SIZE);
...
TEST_CASE_METHOD(ApplicationTestsFixture, "JE::Application is run and dispatches MousePressEvent to InputController", "[JE::Application]")
{
    auto& window = m_WindowController.CreateWindow(NEW_WINDOW_TITLE, NEW_WINDOW_SIZE);
...
TEST_CASE_METHOD(ApplicationTestsFixture, "JE::Application is run and dispatches MouseReleaseEvent to InputController", "[JE::Application]")
{
    auto& window = m_WindowController.CreateWindow(NEW_WINDOW_TITLE, NEW_WINDOW_SIZE);
...
TEST_CASE_METHOD(ApplicationTestsFixture, "JE::Application is run and dispatches MouseMoveEvent to InputController", "[JE::Application]")
{
...
TEST_CASE_METHOD(ApplicationTestsFixture, "JE::Application is run and dispatches MouseWheelEvent to InputController", "[JE::Application]")
{
    auto& window = m_WindowController.CreateWindow(NEW_WINDOW_TITLE, NEW_WINDOW_SIZE);
