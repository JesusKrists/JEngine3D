...
TEST_CASE_METHOD(LoggerTestsFixture, "JE::LoggerController creates Loggers and TestLogger info outputs something", "[JE::LoggerController]")
{
    JE::Logger::TestLogger().info("This is a test message");
    REQUIRE(!JE::Logger::TestLoggerOutput().empty());
}

TEST_CASE_METHOD(LoggerTestsFixture, "JE::LoggerController creates Loggers and TestLogger warn outputs something", "[JE::LoggerController]")
{
