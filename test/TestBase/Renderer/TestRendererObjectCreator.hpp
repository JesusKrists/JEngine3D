...
public:
  ...
  [[nodiscard]] inline auto CreateTexture(const JE::Image &sourceImage)
    -> JE::Scope<JE::ITexture2D, JE::MemoryTag::Renderer> override
  {
    return JE::CreatePolymorphicScope<TestTexture2D, JE::MemoryTag::Renderer, JE::ITexture2D>(
  ...
  [[nodiscard]] inline auto CreateShader(const std::string_view &name,
    const std::string_view &vertexSource,
    const std::string_view &fragmentSource) -> JE::Scope<JE::IShader, JE::MemoryTag::Renderer> override
  {
    return JE::CreatePolymorphicScope<TestShader, JE::MemoryTag::Renderer, JE::IShader>(
      name, vertexSource, fragmentSource);
  }
